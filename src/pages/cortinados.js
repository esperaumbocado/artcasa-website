...
const CortinadosPage = () => {
  ...
  const calhasImages = calhasData.length > 0 
    ? calhasData.flatMap(item => item.processedImages || item.images || [])
    : [
      ...
      <section className="relative py-24 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-700 leading-relaxed font-medium max-w-3xl mx-auto">
            Soluções completas em cortinados e calhas. Desde sistemas de calhas elegantes até cortinados personalizados, criamos o ambiente perfeito para cada espaço.
          </p>
        </div>
      </section>
